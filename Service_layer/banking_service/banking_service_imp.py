...
class BankingServiceImp(BankingServiceInterface):
    ...
    def service_delete_account_by_id(self, customer_id, account_id: int):
        varify_account = account_dao.get_account_by_id(account_id)
    ...
    def service_withdraw_from_account_id(self, withdrawn_amount, account_id: int):
        ...
        return account_dao.withdraw_from_account_id(withdrawn_amount, account_id)
    ...
    def service_deposit_into_account_by_id(self, deposit_amount, account_id: int):
        ...
        return account_dao.deposit_into_account_by_id(deposit_amount, account_id)


    def service_transfer_money_between_accounts_by_their_ids(self, withdraw_id: int, deposit_id: int, transfer_amount):
        return account_dao.transfer_money_between_accounts_by_their_ids(withdraw_id, deposit_id, transfer_amount)
